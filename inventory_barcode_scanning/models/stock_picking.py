...
class StockPickingOperation(models.Model):
    ...
    barcode = fields.Char(string='Barcode', related='product_id.barcode', readonly=False, required=True)

    # barcode_s = fields.Char(string='Product Barcode', related='product_id.barcode')
